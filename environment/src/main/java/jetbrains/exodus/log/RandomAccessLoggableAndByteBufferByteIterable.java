...
public final class RandomAccessLoggableAndByteBufferByteIterable extends ByteBufferByteIterableWithAddress implements RandomAccessLoggable  {

    private final int structureId;
    private final byte type;
    private final byte headerLength;

    RandomAccessLoggableAndByteBufferByteIterable(final long address,
                                             final byte type,
