...
internal class ContextualTemporaryEmptyStore(
    env: ContextualEnvironmentImpl,
    name: String
) : ContextualStoreImpl(env, name, TreeMetaInfo.EMPTY.clone(-1)) {
    ...
    private fun throwCantModify(): Boolean {
