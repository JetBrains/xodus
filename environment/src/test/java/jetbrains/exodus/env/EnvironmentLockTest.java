...
import jetbrains.exodus.io.FileAsyncDataWriter;
...
public class EnvironmentLockTest extends EnvironmentTestsBase {
    ...
    public void testAlreadyLockedEnvironment() {
        ...
        try {
            ...
            first = Environments.newInstance(LogConfig.create(reader,
                    new FileAsyncDataWriter(reader, null)), EnvironmentConfig.DEFAULT);
    ...
    private void openConcurrentEnvironment() {
        ...
        new Job(processor) {
            ...
            protected void execute() {
                ...
                try {
                    FileDataReader reader = new FileDataReader(dir);
                    env = newEnvironmentInstance(LogConfig.create(reader, new FileAsyncDataWriter(reader, LOCK_ID)), new EnvironmentConfig().setLogLockTimeout(5000));
                    wasOpened[0] = true;
