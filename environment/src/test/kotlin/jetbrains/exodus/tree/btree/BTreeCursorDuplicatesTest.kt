...
import jetbrains.exodus.tree.TreeCursorDuplicatesTest

class BTreeCursorDuplicatesTest : TreeCursorDuplicatesTest() {
    ...
    override fun openTree(address: Long, hasDuplicates: Boolean): ITree {
        return BTreeTestBase.doOpenTree(address, hasDuplicates)
    }
}
