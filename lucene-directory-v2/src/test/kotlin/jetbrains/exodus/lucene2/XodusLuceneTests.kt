...
open class XodusLuceneTests : XodusLuceneTestsBase() {
    ...
    override fun tearDown() {
        println("Cache hit rate ${(directory as XodusNonXodusDirectory).hitRate()}")
    ...
    fun addSearchMatch() {
        ...
        closeIndexWriter()
        createIndexSearcher()
        val docs = indexSearcher.search(getQuery(SUMMARY, "sukhoi"), Integer.MAX_VALUE)
    ...
    fun addSearchNonExistent() {
        ...
        closeIndexWriter()
        createIndexSearcher()
        val docs = indexSearcher.search(getQuery(SUMMARY, "sukhoii"), Integer.MAX_VALUE)
    ...
    fun addSearchAnalyzed() {
        addSearchMatch()
        var docs = indexSearcher.search(getQuery(DESCRIPTION, "market"), Integer.MAX_VALUE)
        Assert.assertEquals(1, docs.totalHits.value)
    ...
    fun addSearchWildcards() {
        addSearchMatch()
        var docs = indexSearcher.search(getQuery(DESCRIPTION, "mark*"), Integer.MAX_VALUE)
        Assert.assertEquals(1, docs.totalHits.value)
    ...
    fun addSearchPhrase() {
        addSearchMatch()
        var docs = indexSearcher.search(getQuery(DESCRIPTION, "\"Long-term Cooperation Agreement\""), Integer.MAX_VALUE)
        Assert.assertEquals(1, docs.totalHits.value)
    ...
    fun addSearchExactMatch() {
        addSearchMatch()
        var docs = indexSearcher.search(getQuery(DESCRIPTION, "\"aftersales\""), Integer.MAX_VALUE)
        Assert.assertEquals(1, docs.totalHits.value)
    ...
    fun addSearchPhraseTestQuery() {
        addSearchMatch()
        var query = getQuery(DESCRIPTION, "\"could now start selling\"")
    ...
    fun searchExceptions() {
        addSearchMatch()
        var docs = indexSearcher.search(getQuery(DESCRIPTION, "java.lang.NullPointerException"), Integer.MAX_VALUE)
        Assert.assertEquals(1, docs.totalHits.value)
    ...
    fun trivialMoreLikeThis() {
        ...
        closeIndexWriter()
        createMoreLikeThis()
        moreLikeThis?.fieldNames = arrayOf(DESCRIPTION)
    ...
    fun moreLikeThisByParticularField() {
        ...
        closeIndexWriter()
        createMoreLikeThis()
        moreLikeThis?.fieldNames = arrayOf(DESCRIPTION, SUMMARY)
