...
public class ReverseEntityIdSetIteratorSingleTypeId extends NonDisposableEntityIterator {
    private int index = 0;
    @NotNull
    private final SortedEntityIdSet source;
    @NotNull
    private final Iterator<EntityId> sourceIterator;

    public ReverseEntityIdSetIteratorSingleTypeId(@NotNull EntityIterableBase iterable, @NotNull SortedEntityIdSet source) {
        super(iterable);
        this.source = source;
