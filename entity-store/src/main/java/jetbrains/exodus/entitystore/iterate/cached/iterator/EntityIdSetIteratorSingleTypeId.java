...
public class EntityIdSetIteratorSingleTypeId extends NonDisposableEntityIterator {
    private int index = 0;
    @NotNull
    ...
    public EntityIdSetIteratorSingleTypeId(@NotNull EntityIterableBase iterable, @NotNull SortedEntityIdSet source) {
        super(iterable);
        this.source = source;
