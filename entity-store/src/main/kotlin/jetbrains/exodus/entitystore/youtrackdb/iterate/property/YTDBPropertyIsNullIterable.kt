...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBFieldIsNullCondition
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBSelect

class YTDBPropertyIsNullIterable(
    ...
    override fun query(): YTDBSelect {
        return YTDBClassSelect(entityType, YTDBFieldIsNullCondition(propertyName))
    }
}