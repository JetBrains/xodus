...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBEdgeExistsCondition
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBSelect

class YTDBLinkExistsEntityIterable(
    ...
    override fun query(): YTDBSelect {
        return YTDBClassSelect(entityType, YTDBEdgeExistsCondition(linkName.asEdgeClass))
    }
}
