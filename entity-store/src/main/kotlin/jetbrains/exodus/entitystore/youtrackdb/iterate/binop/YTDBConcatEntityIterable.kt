...
class YTDBConcatEntityIterable(
    txn: YTDBStoreTransaction,
    private val iterable1: YTDBEntityIterable,
    private val iterable2: YTDBEntityIterable
) : YTDBEntityIterableBase(txn) {

    override fun query(): YTDBSelect {
        return YTDBUnionSelect(iterable1.query(), iterable2.query(), false)
    }
}
