...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBLinkOutFromIdSelect
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBSelect

class YTDBLinksFromEntityIterable(
    txn: YTDBStoreTransaction,
    private val linkName: String,
    private val fromEntityId: YTDBEntityId,
) : YTDBEntityIterableBase(txn) {

    override fun query(): YTDBSelect {
        return YTDBLinkOutFromIdSelect(linkName.asEdgeClass, listOf(fromEntityId.asOId()))
    }
}
