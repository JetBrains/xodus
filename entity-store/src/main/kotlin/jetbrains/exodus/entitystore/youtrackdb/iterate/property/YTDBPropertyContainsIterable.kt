...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBContainsCondition
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBSelect

class YTDBPropertyContainsIterable(
    ...
    override fun query(): YTDBSelect {
        val condition = YTDBContainsCondition(propertyName, value, ignoreCase)
