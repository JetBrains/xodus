...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBCollectionContainsCondition
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBSelect

class YTDBPropertyCollectionContainsIterable(
    ...
    override fun query(): YTDBSelect {
        val condition = YTDBCollectionContainsCondition(propertyName, value)
