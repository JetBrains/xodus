...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBEdgeIsNullCondition
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBSelect

class YTDBLinkIsNullEntityIterable(
    ...
    override fun query(): YTDBSelect {
        return YTDBClassSelect(entityType, YTDBEdgeIsNullCondition(linkName.asEdgeClass))
    }
}
