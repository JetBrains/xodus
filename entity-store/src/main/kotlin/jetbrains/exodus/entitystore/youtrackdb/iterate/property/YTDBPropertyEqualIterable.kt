...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBEqualCondition
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBSelect

class YTDBPropertyEqualIterable(
    ...
    override fun query(): YTDBSelect {
        return YTDBClassSelect(entityType, YTDBEqualCondition(propertyName, value))
    }
}
