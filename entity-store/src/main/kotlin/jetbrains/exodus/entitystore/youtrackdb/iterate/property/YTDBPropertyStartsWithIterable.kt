...
import jetbrains.exodus.entitystore.youtrackdb.query.YTDBStartsWithCondition

class YTDBPropertyStartsWithIterable(
    ...
    override fun query(): YTDBSelect {
        val condition = YTDBStartsWithCondition(propertyName, value)
