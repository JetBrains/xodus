...
public interface ModelMetaData {
    ...
    @Nullable
    EntityMetaData getEntityMetaData(@NotNull String entityType);

    Iterable<EntityMetaData> getEntitiesMetaData();

    AssociationMetaData addAssociation(String sourceEntityName, String targetEntityName,
    ...
    AssociationMetaData removeAssociation(String entityName, String associationName);
