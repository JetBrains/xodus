...
class BackupTests : EntityStoreTestBase() {
    ...
    fun testSingularDynamic() {
        ...
        val backupController = (store.environment as EnvironmentImpl).backupController
        ...
        try {
            ...
            newStore.use {
                ...
                newStore.executeInReadonlyTransaction { t ->
                    ...
                    assertEquals(issueCount.toLong(), txn.getAll("Issue").size())
                    ...
                    for (issue in txn.getAll("Issue")) {
                        ...
                        assertFalse(description.isNullOrEmpty())
                    }
                }
            }
        } finally {
