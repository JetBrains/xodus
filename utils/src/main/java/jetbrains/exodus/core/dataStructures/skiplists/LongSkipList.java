...
public class LongSkipList extends SkipListBase {
    ...
    public abstract static class SkipListNode {
        ...
        protected SkipListNode(final long key) {
            this.key = key;
        }
    ...
    public LongSkipList() {
        root = new SkipListInternalNode(Long.MIN_VALUE);
        clear();
    }
    ...
    public void add(final long key) {
        ...
        switch (level) {
            ...
            default: {
                final SkipListInternalNode internalNode = new SkipListInternalNode(key);
    ...
    private static final class SkipListInternalNode extends SkipListNode {
        ...
        private SkipListInternalNode(final long key) {
            super(key);
        }
    ...
    private static final class SkipListBottomNode extends SkipListNode {
        ...
        private SkipListBottomNode(final long key) {
            super(key);
        }
    ...
    private static final class SkipListLevel2Node extends SkipListNode {
        ...
        private SkipListLevel2Node(final long key) {
            super(key);
        }
    ...
    private static final class SkipListLevel3Node extends SkipListNode {
        ...
        private SkipListLevel3Node(final long key) {
            super(key);
        }
