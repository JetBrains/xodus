...
class MessageDigestTest {
    ...
    fun testSHA256() {
        ...
        md.update(LAZY_DOG.toByteArray())
        Assert.assertEquals(
            "d7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592",
            HexUtil.byteArrayToString(md.digest())
        )
        md.reset()
        md.update(LAZY_COG.toByteArray())
        Assert.assertEquals(
    ...
    @Test
    fun testHexUtil() {
        val s = "0123456789abcdeffedcba9876543210"
    ...
    @Test(expected = IllegalArgumentException::class)
    fun testInvalidHexChar() {
        val s = "0123456789abcdeffedcba9876543210h0"
        Assert.assertEquals(s, HexUtil.byteArrayToString(HexUtil.stringToByteArray(s)))
    }
    ...
    companion object {
         ...
         */
        private const val LAZY_DOG = "The quick brown fox jumps over the lazy dog"
        private const val LAZY_COG = "The quick brown fox jumps over the lazy cog"
    }
}
