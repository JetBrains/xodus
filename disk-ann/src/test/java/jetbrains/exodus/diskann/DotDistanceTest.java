...
public class DotDistanceTest {
    ...
    public void testSmallSegmentVectorsZeroOffset() {
        try (var arena = Arena.openConfined()) {
            ...
            var distance = DiskANN.computeDotDistance(firstSegment, 0, secondSegment, 0,
                    2);
    ...
    public void testSmallSegmentVectorsNonZeroOffset() {
        try (var arena = Arena.openConfined()) {
            ...
            var distance = DiskANN.computeDotDistance(firstSegment, Float.BYTES, secondSegment,
                    2 * Float.BYTES, 2);
            Assert.assertEquals(-23.0f, distance, 0.0f);
        }
    }
    ...
    public void testBigSegmentVectorsOffset() {
        ...
        try (var arena = Arena.openConfined()) {
            ...
            var distance = DiskANN.computeDotDistance(firstSegment, firstOffset * Float.BYTES,
                    secondSegment,
    ...
    public void testSmallSegmentJavaVectorsZeroOffset() {
        try (var arena = Arena.openConfined()) {
            ...
            var distance = DiskANN.computeDotDistance(firstSegment, 0, secondVector);
            Assert.assertEquals(-23.0f, distance, 0.0f);
        }
    }
    ...
    public void testSmallSegmentJavaVectorsNonZeroOffset() {
        try (var arena = Arena.openConfined()) {
            ...
            var distance = DiskANN.computeDotDistance(firstSegment, Float.BYTES, secondVector);
            Assert.assertEquals(-23.0f, distance, 0.0f);
        }
    }
    ...
    public void testBigSegmentJavaVectorsOffset() {
        ...
        try (var arena = Arena.openConfined()) {
            ...
            var distance = DiskANN.computeDotDistance(firstSegment, firstOffset * Float.BYTES, secondVector);
            Assert.assertEquals(-sum, distance, 0.0f);
        }
    }
}
