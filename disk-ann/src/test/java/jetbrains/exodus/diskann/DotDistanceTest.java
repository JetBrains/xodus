...
public class DotDistanceTest {
    ...
    public void testComputeDistanceNoLanes() {
        var dotDistance = new DotDistance();
        var firstVector = new float[]{1.0f, 2.0f, 3.0f};
        var secondVector = new float[]{4.0f, 5.0f, 6.0f};
        var distance = dotDistance.computeDistance(firstVector, secondVector);
    ...
    public void testComputeDistanceWithNonZeroOffsetsNoLanes() {
        ...
        var secondVector = new float[]{4.0f, 5.0f, 6.0f};
        var distance =
                dotDistance.computeDistance(firstVector, 1, secondVector, 1, 1);
    ...
    public void testComputeDistanceWitLanesNonZeroOffsets() {
        ...
        var distance = dotDistance.computeDistance(firstVector, 3, secondVector, 2,
                laneSize + 2);
        Assert.assertEquals(-sum, distance, 0.0);
    }
